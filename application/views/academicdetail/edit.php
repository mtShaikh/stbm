...
<?php echo form_open('academicdetail/edit/'.$academicdetail['ID'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
			...
			<div class="col-md-8">
				<select name="Institution_ID" class="form-control">
					...
					{
						$selected = ($institution['ID'] == $academicdetail['Institution_ID']) ? ' selected="selected"' : null;
